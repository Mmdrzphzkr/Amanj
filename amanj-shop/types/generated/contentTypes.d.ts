...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    full_address: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::address.address'
...
export interface ApiBrandSliderBrandSlider extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'BrandSlider';
    pluralName: 'brand-sliders';
    singularName: 'brand-slider';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiFaqAccordionFaqAccordion
  ...
  info: {
    displayName: 'FaqAccordion';
    pluralName: 'faq-accordions';
    singularName: 'faq-accordion';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::faq-accordion.faq-accordion'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface ApiHeaderHeader extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    parent: Schema.Attribute.Relation<'oneToMany', 'api::header.header'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    order_address: Schema.Attribute.Relation<
      'manyToOne',
      'api::address.address'
    >;
...
export interface ApiPlaceOrderPlaceOrder extends Struct.CollectionTypeSchema {
  collectionName: 'place_orders';
  info: {
    displayName: 'PlaceOrder';
    pluralName: 'place-orders';
    singularName: 'place-order';
  };
  options: {
    draftAndPublish: false;
  };
