  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1 className="page-title">دسته‌بندی مقالات</h1>
          <p className="page-subtitle">{categories?.length ?? 0} دسته‌بندی ثبت شده</p>
        </div>
        <Link href="/dashboard/article-categories/new" className="btn-primary" style={{ textDecoration: "none" }}>
            ...
            {!categories || categories.length === 0 ? (
              ...
              <tr key={category.documentId}>
                ...
                <td style={{ textAlign: "center" }}>
                  <Link href={`/dashboard/article-categories/${category.documentId}`} style={editLinkStyle}>
