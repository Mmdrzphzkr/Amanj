  ...
  useEffect(() => {
    ...
    if (isEditMode && initialData) {
      ...
      setFormData({
        ...
        category:
          attrs.category?.data?.documentId ?? attrs.category?.documentId ?? "",
        author: attrs.author ?? "",
    ...
    try {
      ...
      const payloadData = {
        ...
        content: [
          {
            type: "paragraph",
            children: [{ type: "text", text: formData.content }],
          },
        ],
      ...
      if (!res.ok) {
        ...
        try {
          ...
          errorMsg =
            ...
            JSON.stringify(errorData?.error?.details || errorData);
        } catch {}
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    ...
                    >
                      {(() => {
                        ...
                        const opts = [];
                        for (let y = tj.year - 5; y <= tj.year + 5; y++)
                          opts.push(y);
                        return opts.map((y) => (
                    ...
                    <select
                      value={jMonth}
                      onChange={handleJalaliMonth}
                      style={{ ...inputStyle, flex: 1.5, cursor: "pointer" }}
                    >
                    ...
                    >
                      {Array.from(
                        { length: daysInJalaliMonth(jYear, jMonth) },
                        (_, i) => (
            ...
            <div className="card" style={{ padding: "24px" }}>
              ...
              >
                <div>
                  ...
                  >
                    اگر خالی بماند، عنوان مقاله استفاده می‌شود
                  </p>
                </div>
                <div>
                  <label className="label">
                  ...
                  >
                    حداکثر ۱۶۰ کاراکتر توصیه می‌شود
                  </p>
                </div>
              </div>
            </div>
