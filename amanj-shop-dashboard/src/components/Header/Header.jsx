        ...
        <div className="hidden md:flex justify-end items-center gap-4 relative">
          ...
          <a href="/login" rel="nofollow" className="">
            ...
            >
              ...
              />
              <path
                d="M26.2361 20.818C25.6868 21.4317 24.8885 21.818 24 21.818C22.3431 21.818 21 20.4748 21 18.818C21 17.1611 22.3431 15.818 24 15.818C24.8885 15.818 25.6868 16.2042 26.2361 16.818M19.3391 33.818H28.6609C31.1718 33.818 32.8514 31.2335 31.8316 28.939C30.7178 26.433 28.2326 24.818 25.4902 24.818H22.5098C19.7674 24.818 17.2822 26.433 16.1684 28.939C15.1486 31.2335 16.8282 33.818 19.3391 33.818Z"
                stroke="#3F3F3F"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
