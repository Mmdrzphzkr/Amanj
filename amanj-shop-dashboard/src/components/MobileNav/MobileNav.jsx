        ...
        {(user?.role?.name === "Admin" || user?.role?.type === "admin") && (
          <>
            <Link
              href="/dashboard"
              title="dashboard"
              className="p-2 bg-[#EDE9DE] rounded-full hover:bg-[#DED9CC] transition-all flex items-center"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3F3F3F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
