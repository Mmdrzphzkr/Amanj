...
const Footer = () => {
  ...
  return (
    <>
      <footer className="h-[600px] relative pb-0 md:pb-[65px] flex items-end justify-center flex-col md:flex-row">
        <img
          src={footerImgUrl}
        ...
        <div className="container mx-auto p-4 md:p-8">
          ...
          <p style={{ direction: "ltr"}}  className="text-white text-center md:text-right">
